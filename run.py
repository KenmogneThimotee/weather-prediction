...
from steps.get_historical_feature import get_historical_features, HistoricalFeatureParams
...
def main(
    ...
    for city in load_config():
        pipeline_instance = gitflow_training_pipeline(
            get_historical_data=get_historical_features(HistoricalFeatureParams(city_name=city, stage="trainer")),
            get_validation_data=get_historical_features(HistoricalFeatureParams(city_name=city, stage="validator"), name='get_validation_data'),
            ...
            model_register=mlflow_register_model_step(
                MLFlowRegistryParameters(name="weather_model")
            ),
            model_deployer=mlflow_model_deployer_step(MLFlowDeployerParameters(registry_model_name="weather_model")),
